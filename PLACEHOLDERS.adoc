...
|`+Jewell+` |Author surname (for citations) |`+Doe+`
|docs/CITATIONS.adoc

|`+Jonathan+` |Author first name (for citations) |`+Jane+`
|docs/CITATIONS.adoc

|`+J.D.A.+` |Author initials (for citations) |`+J.+`
|docs/CITATIONS.adoc
|===
...
|===
|Placeholder |Description |Example |Files
|`+JuliaKids.Jl+` |Human-readable project name |`+My Project+`
|SECURITY.md, CODE_OF_CONDUCT.md, TOPOLOGY.md, STATE.a2ml, Justfile,
GOVERNANCE.md, MAINTAINERS.md, flake.guix, devcontainer.json

|`+JuliaKids.jl+` |One-line description |`+A tool for X+` |flake.guix

|`+JuliaKids.jl+` |Uppercase identifier (for Idris2 modules, C macros)
...
|`+JuliaKids.jl+` |Repository name (slug) |`+my-project+`
...
|`+2026-03-16+` |Last updated date |`+2026-02-14+` |TOPOLOGY.md,
THREAT-MODEL.md
|===
...
|`+JuliaKids.jl+` |One-line project description
