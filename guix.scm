...
;;
;; Guix package definition for JuliaKids.jl
;;
;; Usage:
;;   guix shell -D -f guix.scm    # Enter development shell
;;   guix build -f guix.scm       # Build package
;;
;; TODO: Replace JuliaKids.jl and customize inputs for your language/stack.
...
(package
  ...
  (home-page "https://github.com/hyperpolymath/JuliaKids.jl")
  (synopsis "JuliaKids.jl")
