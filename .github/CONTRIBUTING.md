...
git clone <https://github.com/hyperpolymath/JuliaKids.jl.git> cd
JuliaKids.jl
...
toolbox create JuliaKids.jl-dev toolbox enter JuliaKids.jl-dev \#
...
JuliaKids.jl/ ├── src/ \# Source code (Perimeter 1-2) ├── lib/ \#
...
SECURITY.md ├── flake.guix \# Guix flake — fallback (Perimeter 1) ├──
...
runner (Perimeter 1)
    ...
    **When suggesting**:
    ...
    - [`good first issue`](https://github.com/hyperpolymath/JuliaKids.jl/labels/good%20first%20issue) — Simple Perimeter 3 tasks
    - [`help wanted`](https://github.com/hyperpolymath/JuliaKids.jl/labels/help%20wanted) — Community help needed
    - [`documentation`](https://github.com/hyperpolymath/JuliaKids.jl/labels/documentation) — Docs improvements
    - [`perimeter-3`](https://github.com/hyperpolymath/JuliaKids.jl/labels/perimeter-3) — Community sandbox scope
