...
toolbox create JuliaKids.jl-dev toolbox enter JuliaKids.jl-dev # Install
...
JuliaKids.jl/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library
...
Test suite (Perimeter 2-3) ├── .machine_readable/ # ALL machine-readable
...
LICENSE ├── MAINTAINERS.md ├── README.adoc ├── SECURITY.md ├──
flake.guix # Guix flake — fallback (Perimeter 1) ├── guix.scm # Guix
